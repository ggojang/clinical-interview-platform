...
7. The patient-experience assessment uses the dedicated workflow below. Depression instruments require an exact authorized Korean-version resource and license check; never reconstruct PHQ-9 or another instrument from memory. Rheumatoid-arthritis patient global-health VAS is 0–100 and must not be stored as the pain NRS.
