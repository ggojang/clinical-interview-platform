...
class GptExportTests(unittest.TestCase):
    ...
    def test_knowledge_action_exposes_patient_experience_operations(self):
        ...
        self.assertIn("test_result_follow_up", schema)
    ...
    def test_rfe_catalog_and_bundles_are_consistent(self):
        with tempfile.TemporaryDirectory() as output:
            ...
            self.assertEqual(urinary["count"], 74)
            fatigue = json.loads(
            ...
            self.assertEqual(skin["count"], 104)
            ...
            self.assertEqual(constitutional["count"], 78)
