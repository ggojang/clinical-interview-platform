        ...
        with tempfile.TemporaryDirectory() as output:
            ...
            self.assertEqual(
                implemented,
                {
                    ...
                    "allergy_concern", "memory_cognitive_concern", "oral_dental_symptoms", "palpitations", "pregnancy_postpartum_concern", "reproductive_genital_symptoms", "skin_complaint", "upper_respiratory_symptoms", "urinary_symptoms", "wound_minor_injury",
