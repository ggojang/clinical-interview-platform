...
def fragment():
    e = [
        ...
        Q("symptom.systemic_unwellness", "Systemically Unwell", "boolean", "systemic-unwellness", "열과 함께 평소와 달리 전반적으로 매우 아프거나 처진 상태인가요?", 199, [G["function"], G["safety"]], S, safety_relevant=True, reuse_existing=True),
...
def completion(f):
    ...
    common = {
        ...
        "fever.acute_functional_decline_eating_drinking_mobility", "symptom.systemic_unwellness", "fever.pain_present",
