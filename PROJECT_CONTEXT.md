...
- Compiler and Knowledge Packages currently cover fifty materialized Primary Care profiles and not the full Primary Care scope;
...
- Simulation and Evaluation cover only the fifty currently compiled profiles and not the full Primary Care scope;
