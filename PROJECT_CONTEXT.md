...
- Compiler and Knowledge Packages currently cover fifty-three materialized Primary Care profiles and not the full Primary Care scope;
...
- Simulation and Evaluation cover only the fifty-three currently compiled profiles and not the full Primary Care scope;
