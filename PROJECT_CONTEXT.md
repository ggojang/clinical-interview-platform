...
- Compiler and Knowledge Packages currently cover fifty-two materialized Primary Care profiles and not the full Primary Care scope;
...
- Simulation and Evaluation cover only the fifty-two currently compiled profiles and not the full Primary Care scope;
