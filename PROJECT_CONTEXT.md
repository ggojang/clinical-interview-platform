...
- Compiler and Knowledge Packages currently cover forty-seven materialized Primary Care profiles and not the full Primary Care scope;
...
- Simulation and Evaluation cover only the forty-seven currently compiled profiles and not the full Primary Care scope;
