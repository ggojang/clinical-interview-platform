...
- Compiler and Knowledge Packages currently cover only the twenty-eight materialized Primary Care vertical slices listed above and not the full Primary Care scope;
...
- Simulation and Evaluation cover only the twenty-eight currently compiled vertical slices and not the full Primary Care scope;
