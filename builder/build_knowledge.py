...
PROFILES = {
    ...
    "memory_cognitive_concern": {
        "base_graph": ROOT / "knowledge/base/primary-care-memory-cognitive-concern.json",
        "base_rules": ROOT / "rules/base/primary-care-memory-cognitive-concern.json",
        "fragment_root": ROOT / "knowledge/generated/neurological/memory-cognitive-concern",
        "output_graph": ROOT / "knowledge/graph/primary-care-memory-cognitive-concern.json",
    ...
    "thyroid_concern_follow_up": {
        ...
        "fragment_root": ROOT / "knowledge/generated/endocrine/thyroid-concern-follow-up",
        "output_graph": ROOT / "knowledge/graph/primary-care-thyroid-concern-follow-up.json",
    ...
    "seizure_event_follow_up": {
        "base_graph": ROOT / "knowledge/base/primary-care-seizure-event-follow-up.json",
        "base_rules": ROOT / "rules/base/primary-care-seizure-event-follow-up.json",
    ...
    "test_result_follow_up": {
        "base_graph": ROOT / "knowledge/base/primary-care-test-result-follow-up.json",
        "base_rules": ROOT / "rules/base/primary-care-test-result-follow-up.json",
        "fragment_root": ROOT / "knowledge/generated/follow-up/test-result",
        "output_graph": ROOT / "knowledge/graph/primary-care-test-result-follow-up.json",
    ...
    "tobacco_nicotine_counselling": {
        "base_graph": ROOT / "knowledge/base/primary-care-tobacco-nicotine-counselling.json",
        "base_rules": ROOT / "rules/base/primary-care-tobacco-nicotine-counselling.json",
        "fragment_root": ROOT / "knowledge/generated/preventive/tobacco-nicotine-counselling",
        "output_graph": ROOT / "knowledge/graph/primary-care-tobacco-nicotine-counselling.json",
    ...
    "physical_activity_counselling": {
        "base_graph": ROOT / "knowledge/base/primary-care-physical-activity-counselling.json",
        "base_rules": ROOT / "rules/base/primary-care-physical-activity-counselling.json",
        "fragment_root": ROOT / "knowledge/generated/preventive/physical-activity-counselling",
        "output_graph": ROOT / "knowledge/graph/primary-care-physical-activity-counselling.json",
        "output_rules": ROOT / "rules/primary-care-physical-activity-counselling.json",
        "version": "0.1.0",
    },
    ...
    "breast_symptoms": {
        "base_graph": ROOT / "knowledge/base/primary-care-breast-symptoms.json",
        "base_rules": ROOT / "rules/base/primary-care-breast-symptoms.json",
        "fragment_root": ROOT / "knowledge/generated/breast/breast-symptoms",
        "output_graph": ROOT / "knowledge/graph/primary-care-breast-symptoms.json",
        "output_rules": ROOT / "rules/primary-care-breast-symptoms.json",
        "version": "0.1.0",
    },
    "kidney_function_ckd_follow_up": {
        ...
        "fragment_root": ROOT / "knowledge/generated/renal/kidney-function-ckd-follow-up",
        "output_graph": ROOT / "knowledge/graph/primary-care-kidney-function-ckd-follow-up.json",
    ...
    "immunization_consultation": {
        "base_graph": ROOT / "knowledge/base/primary-care-immunization-consultation.json",
        "base_rules": ROOT / "rules/base/primary-care-immunization-consultation.json",
        "fragment_root": ROOT / "knowledge/generated/preventive/immunization-consultation",
        "output_graph": ROOT / "knowledge/graph/primary-care-immunization-consultation.json",
